...
public class SharePictureTab extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        edtDescrition = view.findViewById(R.id.edtDescription);
        ...
        switch (view.getId()) {
            ...
            case R.id.btnShareImage:
                if (receivedImageBitmap != null) {
                    if (edtDescrition.getText().toString().equals("")) {
                        FancyToast.makeText(getContext(), "Error you must specify the Description", Toast.LENGTH_SHORT, FancyToast.ERROR, true).show();
                        ...
                        parseObject.put("image_des", edtDescrition.getText().toString());
                    ...
                    FancyToast.makeText(getContext(), "Error you must select Images", Toast.LENGTH_SHORT, FancyToast.ERROR, true).show();
...
//        FancyToast.makeText(getContext(),"Now we can access to the images", Toast.LENGTH_SHORT, FancyToast.SUCCESS,true).show();
